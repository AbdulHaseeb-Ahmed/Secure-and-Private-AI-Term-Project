...
attack_eps_5 = CarliniL2Method(classifier=classifier, confidence=0.0)
...
attack_eps_10 = CarliniL2Method(classifier=classifier, confidence=1)
...
attack_eps_50 = CarliniL2Method(classifier=classifier, confidence=5)
...
attack_eps_95 = CarliniL2Method(classifier=classifier, confidence=10)
